...
# with command line options: --python_filename NuGunE10_GEN_SIM_DIGI_RAW_MINIAOD_cfg.py --eventcontent MINIAODSIM --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-DIGI-RAW-MINIAOD --inputCommands keep * --fileout file:NuGunE10_GEN_SIM_DIGI_RAW_MINIAOD.root --conditions 140X_mcRun4_realistic_v4 --customise_commands process.MINIAODSIMoutput.outputCommands.append('keep *_*_*_HLT'); process.MINIAODSIMoutput.outputCommands.append('keep *_*_*_SIM'); --step RAW2DIGI,RECO,RECOSIM,PAT --geometry Extended2026D110 --nStreams 2 --filein file:NuGunE10_GEN_SIM_DIGI_RAW.root --era Phase2C17I13M9
...
process.load('SimGeneral.MixingModule.mix_POISSON_average_cfi') #added
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:NuGunE10_GEN_SIM_DIGI_RAW_PU140.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_NuGunE10_inMINIAODSIM_PU140.root'),
...
process.MINIAODSIMoutput.outputCommands.append('keep *_*_*_HLT'); process.MINIAODSIMoutput.outputCommands.append('keep *_*_*_SIM');
process.MINIAODSIMoutput.outputCommands.append('keep *_gemSegments_*_*')
process.MINIAODSIMoutput.outputCommands.append('keep *_cscSegments_*_*')
process.MINIAODSIMoutput.outputCommands.append('keep recoMuons_*_*_*')
