...
config.General.requestName = '140X_mcPhase2_14TeV_NuGun_GEN-SIM-DIGI-RAW_PU50_v2'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'NuGunE10_GEN_SIM_DIGI_RAW_PU50_cfg.py'
...
config.Data.outputDatasetTag = '140X_mcPhase2_14TeV_NuGun_GEN-SIM-DIGI-RAW_PU50_v2'
