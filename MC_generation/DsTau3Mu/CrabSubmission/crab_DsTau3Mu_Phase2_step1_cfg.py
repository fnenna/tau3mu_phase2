...
config.General.requestName = '140X_mcPhase2_DsTau3Mu_14TeV_PU200_onlyGEMneg_GEN-SIM-DIGI-RAW_v3'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'DsTau3Mu_step2_DIGI_L1TrackTrigger_L1_DIGI2RAW_HLT_PU_new.py'
...
config.Data.outputDatasetTag = '140X_mcPhase2_DsTau3Mu_14TeV_PU200_onlyGEMneg_GEN-SIM-DIGI-RAW_v3'
