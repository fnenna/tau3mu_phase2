...
config.General.requestName = '140X_mcPhase2_DsTau3Mu_PU200_onlyGEMneg_MINIAOD_gemsegm_v1'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '/lustrehome/felicenenna/tau3mu/CMSSW_14_0_17/src/MC_generation/DsTau3Mu/python/DsTau3Mu_step3_MiniAOD_PU200.py'
...
config.Data.outputDatasetTag = '140X_mcPhase2_DsTau3Mu_PU200_onlyGEMneg_MINIAOD_gemsegm_v1'
