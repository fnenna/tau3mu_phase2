...
# with command line options: --python_filename DsTau3Mu_GEN_SIM_DIGI_RAW_MINIAOD_cfg.py --eventcontent MINIAODSIM --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-DIGI-RAW-MINIAOD --inputCommands keep * --fileout file:DsTau3Mu_GEN_SIM_DIGI_RAW_MINIAOD.root --conditions 140X_mcRun4_realistic_v4 --customise_commands process.MINIAODSIMoutput.outputCommands.append('keep *_*_*_HLT'); process.MINIAODSIMoutput.outputCommands.append('keep *_*_*_SIM'); --step RAW2DIGI,RECO,RECOSIM,PAT --geometry Extended2026D110 --nStreams 2 --filein file:DsTau3Mu_GEN_SIM_DIGI_RAW.root --era Phase2C17I13M9
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/lustrehome/felicenenna/tau3mu/CMSSW_14_0_17/src/MC_generation/DsTau3Mu/step2_DsTau3Mu_DIGI.root'),
