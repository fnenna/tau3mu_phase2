...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:DsTau3Mu_GEN-SIM_Phase2.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step2_DsTau3Mu_DIGI.root'),
